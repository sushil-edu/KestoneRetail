...
public class MyAdapterMerchant extends RecyclerView.Adapter<MyAdapterMerchant.ViewHolder> {
    Context context;
    ...
    int dblReport = 0, dblOrder = 0, flagNext=0;
    String storeCode, storeId, pjpID;


    public MyAdapterMerchant(Context context, ArrayList<RowItem> list, ArrayList<HolderFlag> listFlag, String pjpID, String storeId, String storeCode, OnItemClick listener) {
...
//            }
    ...
    @Override
    public MyAdapterMerchant.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
...
//                        listener.onClick( rowItem.getTitle(), position );
//                    }else {
//                        Toast.makeText( context, "Complete your first activity", Toast.LENGTH_SHORT ).show();
//                    }
//                } else {
//                    //checked
//                    if (position == 0) {
