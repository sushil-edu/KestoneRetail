...
public class DeviationActivity extends AppCompatActivity implements View.OnClickListener, ApiResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateBtn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                     //store
                     if (new ConnectionStatus( DeviationActivity.this ).isNetworkAvailable()) {
                        new DeivationUpdate().execute();
                    } else {
                        Toast.makeText( DeviationActivity.this, "No Internet Connection", Toast.LENGTH_SHORT ).show();
                    }


                } else
                    Toast.makeText( DeviationActivity.this, "Fill All Details First", Toast.LENGTH_SHORT ).show();
            }
        } );
...
//            Intent intent = new Intent(DeviationActivity.this, SignInActivity.class);
...
//        } else
    ...
    public void populateGenre(String response) {
        ...
        if (response.length() > 0) {
            Progress.showProgress( DeviationActivity.this );
            ...
            try {
                ...
                LayoutInflater inflater = LayoutInflater.from( DeviationActivity.this );
                final View dialogLayout = inflater.inflate( R.layout.store_type, null );
                final AlertDialog.Builder builder = new AlertDialog.Builder( DeviationActivity.this );
                ...
                LinearLayoutManager linearLayoutManager = new LinearLayoutManager( DeviationActivity.this, LinearLayoutManager.VERTICAL, false );
                recyclerView.setLayoutManager( linearLayoutManager );
                recyclerView.setAdapter( new StoreTypeAdpater( DeviationActivity.this, storeTypeList, customAlertDialog, edtStoreType ) );
    ...
    public void populateStoreName(String response) {
        ...
        if (response.length() > 0) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (jObject.getString( "StoreCategory" ).equalsIgnoreCase( edtStoreType.getText().toString() )
                        ...
                        genreData.setStoreCategory( jObject.getString( "StoreCategory" ) );
                ...
                LinearLayoutManager linearLayoutManager = new LinearLayoutManager( DeviationActivity.this, LinearLayoutManager.VERTICAL, false );
                recyclerView.setLayoutManager( linearLayoutManager );
                recyclerView.setAdapter( new StoreNameAdapter( DeviationActivity.this, storeTypeList, customAlertDialog, edtStoreName ) );
            ...
            new StoreNameAdapter( DeviationActivity.this ).notifyDataSetChanged();
                ...
                if (jobj.getString( "retval" ).equalsIgnoreCase( "Deviation Added." )) {
                    ...
                    try {
                        ...
                        if (getIntent().getStringExtra( "Type" ).equalsIgnoreCase( "Merchant" )) {
                            new FetchPjp( DeviationActivity.this, ApiUrl.MerchandiserPJP, jsonObject ).executeOnExecutor( AsyncTask.THREAD_POOL_EXECUTOR );

                        } else
                            new FetchPjp( DeviationActivity.this, ApiUrl.SalesPJP, jsonObject ).executeOnExecutor( AsyncTask.THREAD_POOL_EXECUTOR );
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Progress.closeProgress();
                    }
    ...
    class StoreTypeFetch extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            new ApiListener( DeviationActivity.this, ApiUrl.Store, "GET" ).execute();
...
//            this.apiResponse=(ApiResponse)activity;
        ...
        protected void onPostExecute(String s) {
            ...
            Intent intent = new Intent( DeviationActivity.this, DashBoard.class );
            intent.addFlags( Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK );
